...
#if defined (KOS_LOG_ENABLE)
// user modify
// Define macros inside "easylogging++.h"
// Enables thread-safety - make sure -lpthread linking for linux
#define ELPP_THREAD_SAFE
#define ELPP_FORCE_USE_STD_THREAD
// #define ELPP_FEATURE_PERFORMANCE_TRACKING
// Track up-to microseconds 
// (this includes initializing of el::base::PerformanceTracker 
// as well so might time not be 100% accurate)
// #define ELPP_PERFORMANCE_MICROSECONDS

// Aborts application on first assertion failure. 
// This assertion is due to invalid input e.g, invalid configuration file etc.
